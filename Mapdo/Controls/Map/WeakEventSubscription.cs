...
namespace Mapdo
{
		...
		where TEventArgs : EventArgs
	{
		...
		public WeakEventSubscription(
			...
			: this(source, typeof (TSource).GetTypeInfo().GetDeclaredEvent(sourceEventName), targetEventHandler)
		{
		}
		...
		private void RemoveEventHandler()
		{
			...
			if (source != null)
			{
				_sourceEventInfo.RemoveMethod.Invoke(source, new object[] {CreateEventHandler()});
				_subscribed = false;
			}
		}
		...
		private void AddEventHandler()
		{
			...
			if (source != null)
			{
				_sourceEventInfo.AddMethod.Invoke(source, new object[] {CreateEventHandler()});
				_subscribed = true;
			}
		}
	}
